...
public class TemplateAsgList {
	...
	public static void writeTo(StringBuilder sb, String commonSupertypeName) {
		...
		sb.append("            for (T element : prepared) other_clearParent(element);\n");
		...
		sb.append("        catch (RuntimeException | Error failure) { for (T element : prepared) other_clearParent(element); throw failure; }\n");
		sb.append("        if (changed) invalidateIdentityIndex();\n");
		sb.append("        return changed;\n");
		sb.append("    }\n");
		sb.append("\n");
